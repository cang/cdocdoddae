...
{
	/// <summary>
	/// Summary description for DlgConditionHint.
	/// </summary>
	public class DlgConditionHint :  SiGlaz.Recipes.Dialogs.DlgBase
	{
		#region Members
...
//						dataTable = sourceService.GetHintData(_fabID, _fieldName, _from, _to, string.Empty).Result.Tables[0];
						WebServiceProxy.SourceCmd sourceService = new WebServiceProxy.SourceCmd();
						dataTable = sourceService.GetHintData(_fabID, _fieldName, _from, _to, string.Empty).Result.Tables[0];
						break;
					...
					case FunctionType.SignatureOfSurface:
						...
						dataTable = singleLayerService.GetHintData(_fabID, _fieldName, _from, _to, string.Empty).Result.Tables[0];
						break;
				}
