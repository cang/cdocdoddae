...
namespace DDADBManager.Dialog
{
	...
	/// </summary>
	public class TransferEditDlg : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.RadioButton raDDADB;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(TransferEditDlg));
			...
			this.raDDADB = new System.Windows.Forms.RadioButton();
			...
			// groupBox2
			// 
			this.groupBox2.Location = new System.Drawing.Point(72, 248);
			...
			this.raMoveAll.Text = "Move all data";
			...
			this.groupBox4.Controls.Add(this.raDDAStagingArea);
			this.groupBox4.Controls.Add(this.raDDADB);
			...
			this.pictureBox1.Location = new System.Drawing.Point(240, 83);
			...
			// btnDestination
			// 
			this.btnDestination.Location = new System.Drawing.Point(272, 80);
			...
			// btnSource
			// 
			this.btnSource.Location = new System.Drawing.Point(88, 80);
			this.btnSource.Name = "btnSource";
			this.btnSource.Size = new System.Drawing.Size(136, 23);
			this.btnSource.TabIndex = 2;
			this.btnSource.Text = "Source Connection";
			this.btnSource.Click += new System.EventHandler(this.btnSource_Click);
			// 
			// raDDAStagingArea
			// 
			this.raDDAStagingArea.Location = new System.Drawing.Point(32, 48);
			this.raDDAStagingArea.Name = "raDDAStagingArea";
			this.raDDAStagingArea.Size = new System.Drawing.Size(280, 24);
			this.raDDAStagingArea.TabIndex = 1;
			this.raDDAStagingArea.Text = "Move Data DDAStagingArea to DDA Archives ";
			// 
			// raDDADB
			// 
			this.raDDADB.Checked = true;
			this.raDDADB.Location = new System.Drawing.Point(32, 24);
			this.raDDADB.Name = "raDDADB";
			this.raDDADB.Size = new System.Drawing.Size(280, 24);
			this.raDDADB.TabIndex = 0;
			this.raDDADB.TabStop = true;
			this.raDDADB.Text = "Move Data from DDADB to DDAStagingArea";
			// 
			// hpToDDAStagingArea
			// 
		...
		DDADBManager.Process.TransferProcess _DataSource;
		...
		private void btnSource_Click(object sender, System.EventArgs e)
		{
			...
			dlg.Text = "Source Connection";
			dlg.DataSource = this.DataSource.source;
			if( dlg.ShowDialog(this) == DialogResult.OK)
			{
				this.DataSource.source = dlg.DataSource;
			}
		}
		...
		public DDADBManager.Process.TransferProcess DataSource
		{
			get
			{
				if( _DataSource==null)
					_DataSource = new DDADBManager.Process.TransferProcess();

				if(raDDADB.Checked)
					_DataSource.transferType = SiGlaz.Common.DDA.DDADBType.DDADB;
				else
					_DataSource.transferType = SiGlaz.Common.DDA.DDADBType.DDAStagingArea;
			...
			set
			{
				if(value!=null)
				{
					...
					raDDADB.Checked = _DataSource.transferType == SiGlaz.Common.DDA.DDADBType.DDADB;
					raDDAStagingArea.Checked = _DataSource.transferType == SiGlaz.Common.DDA.DDADBType.DDAStagingArea;
