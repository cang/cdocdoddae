...
namespace SiGlaz.Windows
{
	...
	public class ColorPanel : System.Windows.Forms.UserControl
	{
		...
		public SiGlaz.Windows.ColorSet ColorSet
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSet", value, typeof(SiGlaz.Windows.ColorSet) );
		...
		public SiGlaz.Windows.ColorSortOrder ColorSortOrder
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSortOrder", value, typeof(SiGlaz.Windows.ColorSortOrder) );
