...
namespace SiGlaz.Windows
{
	...
	{
		private SiGlaz.Windows.ColorPanelWithCapture colorPanel = null;
		...
		{
			this.colorPanel = new SiGlaz.Windows.ColorPanelWithCapture();
			this.SuspendLayout();
			// 
			// colorPanel
			// 
			...
			this.colorPanel.ColorSet = SiGlaz.Windows.ColorSet.Web;
			this.colorPanel.ColorSortOrder = SiGlaz.Windows.ColorSortOrder.Brightness;
			...
			this.colorPanel.ColorChanged += new SiGlaz.Windows.ColorChangedEventHandler(this.colorPanel_ColorChanged);
			this.colorPanel.PanelClosing += new SiGlaz.Windows.ColorPanelClosingEventHandler(this.colorPanel_PanelClosing);
		...
		private void colorPanel_ColorChanged(object sender, SiGlaz.Windows.ColorChangedEventArgs e)
		{
		...
		public SiGlaz.Windows.ColorSet ColorSet
		{
			get
			{
		...
		public SiGlaz.Windows.ColorSortOrder ColorSortOrder
		{
			get
			{
