...
namespace DataInstaller
{
	...
	public class RijndaelCrypto
	{
		...
		/// Default constructor
		/// </summary>
		public RijndaelCrypto() : this("Pa%$y7&ut", "@1B2c3D4e5F6g7H8")
		{
		}
		...
		/// </remarks>
		public RijndaelCrypto(string  passPhrase) : this(passPhrase, null)
		{
		}
		...
		/// in secret.
		/// </param>
		public RijndaelCrypto(string  passPhrase, string  initVector) : this(passPhrase, initVector, -1)
		{
		}
		...
		/// bytes).
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen) : this(passPhrase, initVector, minSaltLen, -1)
		{
		}
		...
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen, int maxSaltLen) : this(passPhrase, initVector, minSaltLen, maxSaltLen, -1)
		{
		}
		...
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize) : this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, null)
		{
		}
		...
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen, int maxSaltLen,  int keySize, string hashAlgorithm) :  this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, hashAlgorithm, null)
		{
		}
		...
		/// can be any string.
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen, int maxSaltLen, int keySize, string hashAlgorithm, string saltValue) : this(passPhrase, initVector, minSaltLen, maxSaltLen, keySize, hashAlgorithm, saltValue, 1)
		{
		}
		...
		/// </param>
		public RijndaelCrypto(string passPhrase, string initVector, int minSaltLen, int maxSaltLen,  int keySize, string hashAlgorithm, string saltValue, int passwordIterations)
		{
...
//	/// <summary>
//	/// Illustrates the use of RijndaelCrypto class to encrypt and decrypt data
//	/// using a random salt value.
//	/// </summary>
//	public class RijndaelCryptoTest
//	{
//		/// <summary>
...
//			// used defaults).
//			RijndaelCrypto rijndaelKey = 
//				new RijndaelCrypto(passPhrase, initVector);
// 
