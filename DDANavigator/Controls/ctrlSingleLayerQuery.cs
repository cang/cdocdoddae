...
{
	public class ctrlSingleLayerQuery : ctrlBase//System.Windows.Forms.UserControl
	{
		#region Members
		...
		private string _configPath = string.Format("{0}\\SingleLayer.xml", AppData.ApplicationDataPath);
		#endregion
		
		#region Constructor & Destructor
		public ctrlSingleLayerQuery()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ctrlSingleLayerQuery));
			...
			this.tabDataSource.Size = new System.Drawing.Size(1024, 828);
			...
			this.pageProperties.Size = new System.Drawing.Size(1016, 801);
			...
			this.panel1.Size = new System.Drawing.Size(1016, 801);
			...
			this.pageTable.Size = new System.Drawing.Size(1016, 801);
			...
			this._ctrlTableView.Size = new System.Drawing.Size(1016, 801);
			...
			// 
			// ctrlSingleLayerQuery
			// 
			this.Controls.Add(this.tabDataSource);
			this.Name = "ctrlSingleLayerQuery";
		...
		{
			_tableLayout = TableLayout.GetTableLayoutConfig(FunctionType.SingleLayer);
		}

		public void SetTableLayoutConfig()
		{
			TableLayout.SetTableLayoutConfig(GetTableLayout(), FunctionType.SingleLayer);
		}

		public TableLayout GetTableLayout()
		{
			if(_tableLayout == null || _tableLayout.DisplayColumns == null || _tableLayout.DisplayColumns.Length <= 0)
				_tableLayout = new TableLayout(true);
...
//			{
				...
				_ctrlTableView.RefreshData(_singleLayer, FunctionType.SingleLayer);
...
//			}
		...
		private void btnSelectColumns_Click(object sender, System.EventArgs e)
		{
			...
			DlgTableLayout dlg = new DlgTableLayout(_tableLayout, FunctionType.SingleLayer);
