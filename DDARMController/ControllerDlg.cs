...
{
	public class ControllerDlg : System.Windows.Forms.Form
	{
		#region Members
		...
		private System.Windows.Forms.ToolStripMenuItem miDefineGrade;
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ControllerDlg));
            ...
            // mnuItemNewRecipe
            // 
            this.mnuItemNewRecipe.Image = global::DDARMController.Properties.Resources._0;
            ...
            // mnuItemEditRecipe
            // 
            this.mnuItemEditRecipe.Image = global::DDARMController.Properties.Resources._1;
            ...
            // mnuItemDeleteRecipe
            // 
            this.mnuItemDeleteRecipe.Image = global::DDARMController.Properties.Resources._2;
            ...
            // menuItemDeleteAll
            // 
            this.menuItemDeleteAll.Image = global::DDARMController.Properties.Resources._3;
            ...
            // menuItemRefresh
            // 
            this.menuItemRefresh.Image = global::DDARMController.Properties.Resources._5;
            ...
            // menuItemRun
            // 
            this.menuItemRun.Image = global::DDARMController.Properties.Resources._6;
            ...
            // menuItemStop
            // 
            this.menuItemStop.Image = global::DDARMController.Properties.Resources._7;
            ...
            // menuItemRunAll
            // 
            this.menuItemRunAll.Image = global::DDARMController.Properties.Resources._8;
            ...
            // menuItemStopAll
            // 
            this.menuItemStopAll.Image = global::DDARMController.Properties.Resources._9;
            ...
            this.miDefineGrade.Text = "Define DDAGrade";
            ...
            this.menuItem4.Size = new System.Drawing.Size(107, 22);
		...
		private ctrlRRecipeList _ctrlRecipeList;
		...
		private bool NoAnyStop(ArrayList recipes)
		{
			foreach(DDARecipe.DDARecipe recipe in recipes)
			{
				if(!recipe.IsRunning || recipe.WaitingToRun || recipe.WaitingToStop )
		...
		private delegate void UpdateCommandGUIHandler();
		...
		public void  UpdateCommandGUI()
		{
			...
			{
				UpdateCommandGUIHandler dele = new UpdateCommandGUIHandler(UpdateCommandGUISafe);
				this.BeginInvoke(dele,null);
			}
		...
		public void  UpdateCommandGUISafe()
		{
			...
			btnRun.Enabled = menuItemRun.Enabled = this.IsRun(selectedRecipeList) && !_ctrlRecipeList.timer1.Enabled && !_ctrlRecipeList.timer2.Enabled;
			btnStop.Enabled = menuItemStop.Enabled = this.IsStop(selectedRecipeList) && !_ctrlRecipeList.timer1.Enabled && !_ctrlRecipeList.timer2.Enabled;

			btnRunAll.Enabled = menuItemRunAll.Enabled = this.NoAnyRun(recipeList) && !_ctrlRecipeList.timer1.Enabled && !_ctrlRecipeList.timer2.Enabled;
			btnStopAll.Enabled = menuItemStopAll.Enabled = this.NoAnyStop(recipeList) && !_ctrlRecipeList.timer1.Enabled && !_ctrlRecipeList.timer2.Enabled;
		...
		private void InitializeComponentDynamic()
		{
			...
			_ctrlRecipeList = new ctrlRRecipeList();
...
//					break;
				...
				case "Show Process Step":
                    if (this.miShowProcessStep.Image == null)
                        this.miShowProcessStep.Image = global::DDARMController.Properties.Resources._10;
                    else
...
//			}
			...
			StartUp.LoadApplicationDataFromServer();//new
			...
			if( dlg.ShowDialog(this) == DialogResult.OK)
			{
				...
				RemotableEventController.Controler.RemoteRecipeList.SetConnectionParam(param);

				byte[] lpbyte= SiGlaz.Common.DDA.AppData.Data.SaveApplicationData();

				DDARecipe.DDAExternalData.CheckFab();

				if(!RemotableEventController.Controler.RemoteRecipeList.SaveApplicationConfig(lpbyte))
				{
					MessageBox.Show(this,"DDAServices cannot connect to database. Please check database and restart DDAServices",Application.ProductName,MessageBoxButtons.OK,MessageBoxIcon.Error);
					return;
				}
				RemotableEventController.Controler.RemoteRecipeList.RefreshExternalData();

				//Refresh for DDADB Manager server - maybe not need here
				RemotableEventController.Controler.RemoteSchema.SetConnectionParam(param);
				RemotableEventController.Controler.RemoteSchema.SaveApplicationConfig(lpbyte);
				RemotableEventController.Controler.RemoteSchema.RefreshExternalData();

				RemotableEventController.Controler.RemoteSchema.HandlerOnRefresh(string.Empty);
		...
		{
			RemotableEventController.Controler.stop = true;
		}
		...
		public void ReLoadSchema(SiGlaz.Recipes.RecipeEventArgs e)
		{
			try
			{
				StartUp.LoadApplicationDataFromServer();//new

				this._ctrlRecipeList.LoadRecipeList();

				this.UpdateCommandGUI();
			}
			catch
			{
				MessageBox.Show(this,"Cannot refresh recipelist from server changing");
			}
		}
