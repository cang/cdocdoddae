...
namespace SiGlaz.Common.DDA
{
	public class DataGriComboColumn : DataGridColumnStyle 
	{
		...
		public DataGriComboColumn() : base() 
		{
			...
			myCombo.Leave += new EventHandler(myCombo_Leave);
			myCombo.LostFocus +=new EventHandler(myCombo_LostFocus);
		}
...
//		}
		...
		private void myCombo_Leave(object sender, EventArgs e)
		{
			myCombo.Visible = false;
		}

		private void myCombo_LostFocus(object sender, EventArgs e)
		{
			myCombo.Visible = false;
		}
	}
